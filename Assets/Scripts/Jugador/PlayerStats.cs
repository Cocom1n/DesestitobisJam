...
public class PlayerStats : MonoBehaviour, IEffectTarget
{
    ...
    [SerializeField] private float cantBomb = 3;
    ...
    public void SetTopSpeed(float value) { topSpeed = value; }
    ...
    public void SetCantBomb(float value) { cantBomb = value; }

    public float GetCantBomb() { return cantBomb; }
    ...
    public void ResetColor() { SetColor(originalColor); }
}
